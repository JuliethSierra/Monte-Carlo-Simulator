  ...
  # Método para simular la anotación de un punto
    ...
    def establish_winner_tournament(self, player1: 'Player', player2: 'Player', tournament: 'Tournament')-> None:
        if player1.get_sets_won() > player2.get_sets_won():
            ...
            print("SUMA TORNEO +1 j1")
            print(player1.get_total_tournaments_won())
            ...
            print("SUMA TORNEO +1 j2")
            print(player2.get_total_tournaments_won())
    ...
    def get_player_more_victories_game(self, player1: 'Player', player2: 'Player') -> 'Player':
        if player1.get_total_games_won() > player2.get_total_games_won():
            print("Jugador con más juegos ganados", player1.get_total_games_won())
            return player1
        else:
            print("Jugador con mas juegos ganados", player2.get_total_games_won())
            return player2
    ...
    def get_player_more_victories_set(self, player1: 'Player', player2: 'Player') -> 'Player':
        if player1.get_total_sets_won() > player2.get_total_sets_won():
            print("Jugador con más sets ganados", player1.get_total_sets_won())
            return player1
        else:
            print("Jugador con mas sets ganados", player2.get_total_sets_won())
            return player2
    ...
    def get_player_more_victories_tournament(self, player1: 'Player', player2: 'Player') -> 'Player':
        if player1.get_total_tournaments_won() > player2.get_total_tournaments_won():
            print("Jugador con más sets ganados", player1.get_total_tournaments_won())
            return player1
        else:
            print("Jugador con mas sets ganados", player2.get_total_tournaments_won())
            return player2
    #Metodo para Obtener los puntajes de los jugadores en cada unos de los juegos
    #Metodo para Obtener al jugador que ganó cada sorteo
    #Metodo para Obtener al jugador que ganó cada torneo con su puntaje
    ...
    def simulacion_round(self, player1: 'Player', player2: 'Player',tournament: 'Tournament') -> ResultGame:
        ...
        resultGame = ResultGame(
            ...
            #scores_per_game
            #initial_raffle_winner_per_game
        )
